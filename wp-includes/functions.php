...
/*function fa_get_wpsmiliestrans()
{
    ...
    foreach ($wpsmilies as $alt => $src_path) {
        $output .= '<a class="add-smily" data-smilies="' . $alt . '"><img class="wp-smiley" src="/wp-includes/images/smilies/' . $src_path . '"/></a>';
    }
    return $output;
}*/
function fa_get_wpsmiliestrans(){
    ...
    foreach($wpsmilies as $alt => $src_path){
        ...
        $output .= '<a class="add-smily" data-smilies="'.$alt.'"><img class="wp-smiley" src="'.get_bloginfo('template_directory').'/smilies/'. $emoji .'.png" /></a>';
    }
    return $output;
}
//给评论添加表情支持
